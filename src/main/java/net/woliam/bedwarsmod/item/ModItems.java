...
import net.woliam.bedwarsmod.item.custom.BridgeEggItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> BRIDGEEGG = ITEMS.register("bridgeegg",
            () -> new BridgeEggItem(new Item.Properties().stacksTo(16)));
